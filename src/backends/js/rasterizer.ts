 ...
 * slot packs, the same way {@link rasterizeTriangles} already requires it.
 */
 ...
 * a general rasterizer. Superseded by {@link compileJS}'s `JsRasterRoutine`
 * for anything needing clipping/depth testing/batched draws; kept for
 * existing callers and as the WASM rasterizer's own reference oracle.
 */
